...
namespace UsersIdentity.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(UserManager<AppUser> usrMgr) => userManager = usrMgr;

        [Authorize]
        public ViewResult Index() => View(GetData(nameof(Index)));

        //[Authorize(Roles = "Users")]
        // Require authenticated user with Users Role and required Claim named "StateOrProvince" is "DC"
