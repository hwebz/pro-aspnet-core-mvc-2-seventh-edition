...
namespace ModelValidation.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ViewResult MakeBooking(Appointment appt)
        {
            ...
            //{
            //    ModelState.AddModelError(nameof(appt.Date), "Please enter a date in the feature");
            //}

            if (ModelState.GetFieldValidationState(nameof(appt.Date)) == ModelValidationState.Valid && ModelState.GetValidationState(nameof(appt.ClientName)) == ModelValidationState.Valid && appt.ClientName.Equals("Joe", StringComparison.OrdinalIgnoreCase) && appt.Date.DayOfWeek == DayOfWeek.Monday)
            {
